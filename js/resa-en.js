...
document.getElementById("redirect").onclick = function () {
    ...
    window.open("https://www.secure-hotel-booking.com/Hotel-La-Ponche/JRU8/en?hotelId=25266&selectedAdultCount=" + adultCount + "&selectedChildCount=" + childCount + "&arrivalDate=" + arrivalDate + "&departureDate=" + departureDate + "&promocode=" + promo,
    '_blank')
}
