...
document.getElementsByClassName("redirection").onclick = function () {
    document.getElementsByClassName("resa")[0].style.display = "initial";
    if (typeof window.orientation !== 'undefined') {
        $(".houdini").each(function () {
            $(this).hide()
...
document.getElementById("redirect").onclick = function () {
    ...
    window.open("https://www.secure-hotel-booking.com/Hotel-La-Ponche/JRU8/fr?hotelId=25266&selectedAdultCount=" + adultCount + "&selectedChildCount=" + childCount + "&arrivalDate=" + arrivalDate + "&departureDate=" + departureDate + "&promocode=" + promo,
    '_blank')
}
